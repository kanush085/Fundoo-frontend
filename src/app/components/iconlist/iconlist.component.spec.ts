...
import { MatSnackBarModule, MatCheckboxModule, MatSelectModule, MatMenuModule, MatTooltipModule, MatDialogModule, MatInputModule, MatSidenavModule, MatNativeDateModule } from "@angular/material";
...
describe('IconlistComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ IconlistComponent,LoginComponent,RegisterComponent,ResetpasswordComponent,DashboardComponent
        ,NoteComponent,ArchiveComponent,TrashComponent,UpdatenoteComponent,
       LabelsComponent,TakenoteComponent,ReminderComponent,ImageCropperComponent,DisplaynoteComponent,LabelpipePipe,ForgotpasswordComponent,
       IconlistComponent ],
       imports:[
        MatInputModule,
